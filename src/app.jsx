...
const DS_SEMANTIC_TOKENS = [
  ...
  { category: 'Text', tokens: [
    { name: '--color-text-strong',      lightHex: '#000000', darkHex: '#EAEBEC' },
    { name: '--color-text-default',     lightHex: '#212225', darkHex: '#DBDCDF' },
    { name: '--color-text-subtle',      lightHex: '#878A93', darkHex: '#989BA2' },
    { name: '--color-text-placeholder', lightHex: '#C2C4C8', darkHex: '#5A5C63', lightBorder: true },
    { name: '--color-text-disabled',    lightHex: '#E1E2E4', darkHex: '#46474C', lightBorder: true },
  ]},
  { category: 'Icon', tokens: [
    { name: '--color-icon-default', lightHex: '#989BA2', darkHex: '#70737C' },
  ]},
  { category: 'Background', tokens: [
    { name: '--color-bg-default',      lightHex: '#FFFFFF', darkHex: '#1B1C1E', lightBorder: true },
    { name: '--color-bg-subtle',       lightHex: '#F7F7F8', darkHex: '#212225', lightBorder: true },
    { name: '--color-bg-muted',        lightHex: '#F4F4F5', darkHex: '#2E2F33', lightBorder: true },
    { name: '--color-surface-default', lightHex: '#EAEBEC', darkHex: '#37383C', lightBorder: true },
    { name: '--color-surface-track',   lightHex: '#DBDCDF', darkHex: '#46474C', lightBorder: true },
  ]},
  { category: 'Border', tokens: [
    { name: '--color-border-default', lightHex: '#EAEBEC', darkHex: '#37383C', lightBorder: true },
    { name: '--color-border-subtle',  lightHex: '#E1E2E4', darkHex: '#333438', lightBorder: true },
    { name: '--color-border-strong',  lightHex: '#C2C4C8', darkHex: '#46474C', lightBorder: true },
  ]},
  { category: 'Status', tokens: [
    { name: '--color-status-info',    lightHex: '#0066FF', darkHex: '#4F95FF' },
  ...
  { category: 'Gender', tokens: [
    { name: '--color-gender-male',           lightHex: '#4F95FF', darkHex: '#4F95FF' },
    { name: '--color-gender-male-surface',   lightHex: '#EAF2FE', darkHex: '#002130', lightBorder: true },
